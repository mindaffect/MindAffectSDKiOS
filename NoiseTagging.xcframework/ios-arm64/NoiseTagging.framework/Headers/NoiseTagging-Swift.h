...
/// Pages can be:
/// important:
/// Currently this is only available on iPad!
/// <ul>
///   <li>
...
/// <ol>
///   <li>
///     ‘View Pages’: If you set a view, when the page becomes <code>NavigatorTreeOfPages</code>’s current page, <code>NavigatorTreeOfPages</code> simply shows that view beneath its navigation bar.
///   </li>
///   <li>
///     ‘Settings Pages’: If you set an array of settings, the page will create a view, set it on itself, and populate it with UI for editing those settings. This means a Settings Page actually is a specific kind of View Page.
///   </li>
///   <li>
///     ‘List Pages’: If you set <code>subPages</code>, when the page becomes <code>NavigatorTreeOfPages</code>’s current page, <code>NavigatorTreeOfPages</code> shows one row per subPage and lets the user navigate to the subPages.
///   </li>
/// </ol>
